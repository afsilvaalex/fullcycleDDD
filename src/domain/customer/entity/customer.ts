...
import CustomerChangeAddressEvent from "../event/customer-changeAddress.event";
import CustomerCreatedEvent from "../event/customer-created.event";
import SendConsoleWhenCustomerChangeAddress from "../event/handler/send-consoleLog-when-customer-changeAddress-handler";
import SendConsoleLog1WhenCustomerIsCreated from "../event/handler/send-consoleLog1-when-customer-is-created-handler";
import SendConsoleLog2WhenCustomerIsCreated from "../event/handler/send-consoleLog2-when-customer-is-created-handler";
