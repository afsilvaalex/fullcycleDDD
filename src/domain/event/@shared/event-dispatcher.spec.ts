import CustomerChangeAddressEvent from "../customer/customer-changeAddress.event";
import CustomerCreatedEvent from "../customer/customer-created.event";
import SendConsoleWhenCustomerChangeAddress from "../customer/handler/send-consoleLog-when-customer-changeAddress-handler";
import SendConsoleLog1WhenCustomerIsCreated from "../customer/handler/send-consoleLog1-when-cutomer-is-created-handler";
import SendConsoleLog2WhenCustomerIsCreated from "../customer/handler/send-consoleLog2-when-cutomer-is-created-handler";
